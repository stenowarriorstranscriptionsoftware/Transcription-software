...
function compareParagraphs() {
    ...
    var tableContent =
        ...
        '<table>' +
        '<tr>' +
        '<th style="border: 2px solid green;">Total Words in Actual Transcription</th>' +
        '<th style="border: 2px solid green;">Total Words in Your Transcription</th>' +
        '<th style="border: 2px solid green;">Number of Half Mistakes</th>' +
        '<th style="border: 2px solid green;">Number of Full Mistakes</th>' +
        '<th style="border: 2px solid green;">Total Keystrokes in your Transcription</th>' +
        '<th style="border: 2px solid green;">Total Percentage of Mistakes (%)</th>' +
        '</tr>' +
        '<tr>' +
        ...
        '<td style="border: 2px solid green;">' + (((numHalfDiff / 2) + numFullDiff) / paragraphA.length * 100).toFixed(2) + '</td>' +
        '</tr>' +
        '</table>';
